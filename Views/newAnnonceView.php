...
<section class="page-section" id="contact">
			...
			<div class="row justify-content-center">
				<div class="col-lg-6 col-xl-5">
					...
					<input type="hidden" name="id_user"
						value="<?= $_SESSION['connected']?>">

					<div class="form-floating mb-3">
						<input class="form-control" id="titre" type="text"
							name="titre_annonce" placeholder="Titre de l'annonce"
							value="<?php if(isset($errors['value']['titre_annonce'])) { echo $errors['value']['titre_annonce']; }?>" />
					...
					<div class="form-floating mb-3">
						<textarea class="form-control" id="desc" name="desc_annonce"
							placeholder="Description de l'annonce" style="height: 10rem"><?php if(isset($errors['value']['desc_annonce'])) { echo $errors['value']['desc_annonce']; }?></textarea>
					...
					<div class="form-floating mb-3">
						<input class="form-control" id="prix" type="number"
							name="prix_annonce" placeholder="Prix"
							value="<?php if(isset($errors['value']['prix_annonce'])) { echo $errors['value']['prix_annonce']; }?>" />
					...
					<div class="form-floating mb-3">
						<input class="form-control" id="adresse" type="text"
							name="adresse_annonce" placeholder="Adresse de l'annonce"
    ...
    foreach ($listCategories as $categorie) {
        ?>
				...
				<?php if(isset($errors['value']['id_categorie']) && ($categorie['id_categorie'] == $errors['value']['id_categorie'])) { echo 'selected'; }?>>
		...
		<?php } ?>
				...
				<div class="col-lg-6 col-xl-5">
					...
					<div class="form-floating mb-3" style="display: none;" id="surface">
						<input class="form-control" id="surface" type="number"
							name="critere_surface" placeholder="Surface" /> <label
							for="surface">Surface</label>
					</div>
					<div class="form-floating mb-3" style="display: none;"
						id="nombre-de-pieces">
						<input class="form-control" id="surface" type="number"
							name="critere_nombre-de-pieces" placeholder="Nombre de pièces" />
					...
					<div class="form-floating mb-3" style="display: none;" id="marque">
						<input class="form-control" id="marque" type="text"
							name="critere_marque" placeholder="Marque" /> <label for="marque">Marque</label>
					</div>
					<div class="form-floating mb-3" style="display: none;" id="modele">
						<input class="form-control" id="modele" type="text"
							name="critere_modele" placeholder="Modèle" /> <label for="modele">Modèle</label>
					</div>
					<div class="form-floating mb-3" style="display: none;" id="km">
						<input class="form-control" id="km" type="number"
							name="critere_km" placeholder="Kms" /> <label for="km">Kms</label>
					</div>
					<div class="form-floating mb-3" style="display: none;"
						id="carburant">
					...
					<div class="form-floating mb-3" style="display: none;" id="couleur">
						<input class="form-control" id="couleur" type="text"
							name="critere_couleur" placeholder="Couleur" /> <label
							for="couleur">Couleur</label>
					</div>
					<div class="form-floating mb-3" style="display: none;"
						id="nb-de-portes">
						<input class="form-control" id="nb-de-portes" type="number"
							name="critere_nb-de-portes" placeholder="Nombre de portes" /> <label
							for="nb-de-portes">Nombre de portes</label>
					</div>
					<div class="form-floating mb-3" style="display: none;"
						id="puissance">
						<input class="form-control" id="puissance" type="number"
							name="critere_puissance" placeholder="Puissance" /> <label
							for="puissance">Puissance</label>
					</div>
					<div class="form-floating mb-3" style="display: none;"
						id="nb-de-places">
						<input class="form-control" id="nb-de-places" type="number"
							name="critere_nb-de-places" placeholder="Nombre de places" /> <label
							for="nb-de-places">Nombre de places</label>
					</div>

					<!-- telephonie -->
					<div class="form-floating mb-3" style="display: none;"
						id="capacite-de-stockage">
						<input class="form-control" id="capacite-de-stockage"
							type="number" name="critere_capacite-de-stockage"
							placeholder="capacite-de-stockage" /> <label
							for="capacite-de-stockage">Capacité de stockage</label>
					</div>
			...
			<div class="row justify-content-center">
				<div class="col-lg-4 col-xl-3">
					...
					<button class="btn btn-primary btn-xl" id="submitButton"
						name="submit" type="submit">Déposer l'annonce</button>
				</div>
			</div>
		</form>
